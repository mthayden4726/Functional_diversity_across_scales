...
for i,file in enumerate(flights_SRER):
    ...
    img = Data_Dir + "/NEON_D14_SRER_DP1_" + file_name + '_reflectance.h5'
    neon = ht.HyTools() 
    neon.read_file(img,'neon')
    print("file loaded")
    topo_file = "NEON BRDF-TOPO Corrections/2019_SRER/NEON_D14_SRER_DP1_" + file_name + "_reflectance_topo_coeffs_topo.json"
    print(topo_file)
    brdf_file = "NEON BRDF-TOPO Corrections/2019_SRER/NEON_D14_SRER_DP1_" + file_name + "_reflectance_brdf_coeffs_topo_brdf.json"
    try:
    ...
    destination_s3_key = 'TEAK_flightlines/'+ str(file_name)+'_output_' + '.tif'
