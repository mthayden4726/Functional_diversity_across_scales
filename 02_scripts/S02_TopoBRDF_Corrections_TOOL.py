...
search_criteria = "NEON_D18_TOOL_DP1_20190723"
dirpath = "NEON BRDF-TOPO Corrections/2019_TOOL/"
...
for i,file in enumerate(file_names):
    ...
    print(file)
    flight = 'https://storage.googleapis.com/neon-aop-products/2019/FullSite/D18/2019_TOOL_3/L1/Spectrometer/ReflectanceH5/2019072318/NEON_D18_TOOL_DP1_' + file +'_reflectance.h5'
    files = []
    files.append(flight)
    try:
        ...
        continue 
    img = Data_Dir + "/NEON_D18_TOOL_DP1_" + file + '_reflectance.h5'
    neon = ht.HyTools() 
    neon.read_file(img,'neon')
    print("file loaded")
    topo_file = "NEON BRDF-TOPO Corrections/2019_TOOL/NEON_D18_TOOL_DP1_" + file + "_reflectance_topo_coeffs_topo.json"
    print(topo_file)
    #brdf_file = "NEON BRDF-TOPO Corrections/2019_TOOL/NEON_D18_TOOL_DP1_" + file + "_reflectance_brdf_coeffs_topo_brdf.json"
    try:
    ...
    destination_s3_key = 'TOOL_flightlines/'+ str(file)+'_output_' + '.tif'
