...
file_stem = 'PUUM_flightlines/Mosaic_PUUM_'
plots = [
           '005',
           '020',
           '017',
...
for i in plots:
    ...
    results_FR = {}
    local_file_path_fric = Out_Dir + "/PUUM_fric_" + str(i) + ".csv"
    ...
    destination_s3_key_fric = "/PUUM_fric_veg_" + str(i) + ".csv"
    ...
    results_FD = {}
    local_file_path_fdiv = Out_Dir + "/PUUM_fdiv_veg_" + str(i) + ".csv"
    ...
    destination_s3_key_fdiv = "/PUUM_fdiv_veg_" + str(i) + ".csv"
