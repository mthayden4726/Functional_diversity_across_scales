...
file_stem = 'TOOL_flightlines/Mosaic_TOOL_'
plots = ['020',
  '018',
  '003',
  '026',
...
for i in plots:
    ...
    results_FR = {}
    local_file_path_fric = Out_Dir + "/TOOL_fric_" + str(i) + ".csv"
    ...
    destination_s3_key_fric = "/TOOL_fric_veg_" + str(i) + ".csv"
    ...
    results_FD = {}
    local_file_path_fdiv = Out_Dir + "/TOOL_fdiv_veg_" + str(i) + ".csv"
    ...
    destination_s3_key_fdiv = "/TOOL_fdiv_veg_" + str(i) + ".csv"
