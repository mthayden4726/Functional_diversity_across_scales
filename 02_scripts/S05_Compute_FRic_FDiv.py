...
file_stem = 'KONZ_flightlines/Mosaic_KONZ_'
plots = ['005',
              '007',
              '009',
              '019'
...
for i in plots:
    ...
    results_FR = {}
    local_file_path_fric = Out_Dir + "/KONZ_fric_" + str(i) + ".csv"
    ...
    destination_s3_key_fric = "/KONZ_fric_veg_" + str(i) + ".csv"
    ...
    results_FD = {}
    local_file_path_fdiv = Out_Dir + "/KONZ_fdiv_veg_" + str(i) + ".csv"
    ...
    destination_s3_key_fdiv = "/KONZ_fdiv_veg_" + str(i) + ".csv"
