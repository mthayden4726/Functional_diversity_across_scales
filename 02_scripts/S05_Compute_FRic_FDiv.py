...
file_stem = 'CLBJ_flightlines/Mosaic_CLBJ_'
plots = ['003',
         '035',
         '041',
         '053',
...
for i in plots:
    ...
    results_FR = {}
    local_file_path_fric = Out_Dir + "/CLBJ_fric_" + str(i) + ".csv"
    ...
    destination_s3_key_fric = "/CLBJ_fric_veg_" + str(i) + ".csv"
    ...
    results_FD = {}
    local_file_path_fdiv = Out_Dir + "/CLBJ_fdiv_veg_" + str(i) + ".csv"
    ...
    destination_s3_key_fdiv = "/CLBJ_fdiv_veg_" + str(i) + ".csv"
