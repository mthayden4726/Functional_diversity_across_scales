...
file_stem = 'UNDE_flightlines/Mosaic_UNDE_'
plots = ['001',
         '003',
         '006',
         '011',
...
for i in plots:
    ...
    results_FR = {}
    local_file_path_fric = Out_Dir + "/UNDE_fric_" + str(i) + ".csv"
    ...
    destination_s3_key_fric = "/UNDE_fric_veg_" + str(i) + ".csv"
    ...
    results_FD = {}
    local_file_path_fdiv = Out_Dir + "/UNDE_fdiv_veg_" + str(i) + ".csv"
    ...
    destination_s3_key_fdiv = "/UNDE_fdiv_veg_" + str(i) + ".csv"
