...
for i,file in enumerate(file_names):
    ...
    try:
        ...
        continue 
    img = Data_Dir + "/NEON_D11_CLBJ_DP1_" + file + '_reflectance.h5'
    neon = ht.HyTools() 
    neon.read_file(img,'neon')
    print("file loaded")
    topo_file = "NEON BRDF-TOPO Corrections/2019_CLBJ/NEON_D11_CLBJ_DP1_" + file + "_reflectance_topo_coeffs_topo.json"
    print(topo_file)
    ...
    destination_s3_key = 'CLBJ_flightlines/'+ str(file)+'_output_' + '.tif'
