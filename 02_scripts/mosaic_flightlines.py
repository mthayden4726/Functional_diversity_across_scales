...
# Loop through all SRER files
#for file in files_SRER:
#    neon = ht.HyTools() 
#    neon.read_file(file,'neon')
#    neon_id = parse()
#    topo_coeffs = glob.glob(Data_Dir + "/NEON BRDF-TOPO Corrections/2019_SRER/NEON_D14_SRER_DP1_" + neon_id + "_reflectance_topo_coeffs_topo.json")
#    brdf_coeffs = glob.glob(Data_Dir + "/NEON BRDF-TOPO Corrections/2019_SRER/NEON_D14_SRER_DP1_" + neon_id + "_reflectance_brdf_coeffs_topo_brdf.json")
...
# Read in image #1
neon_image= '/Users/meha3816/Library/CloudStorage/OneDrive-UCB-O365/Desktop/BioSCape_across_scales/01_data/01_rawdata/NEON_D17_TEAK_DP1_20190615_171836_reflectance.h5'
neon = ht.HyTools()
neon.read_file(neon_image,'neon')
# Load correction coefficients
topo_coeffs = '/Users/meha3816/Library/CloudStorage/OneDrive-UCB-O365/Desktop/BioSCape_across_scales/01_data/01_rawdata/NEON BRDF-TOPO Corrections/2019_TEAK/NEON_D17_TEAK_DP1_20190615_171836_reflectance_topo_coeffs_topo.json'
neon.load_coeffs(topo_coeffs,'topo')
brdf_coeffs = '/Users/meha3816/Library/CloudStorage/OneDrive-UCB-O365/Desktop/BioSCape_across_scales/01_data/01_rawdata/NEON BRDF-TOPO Corrections/2019_TEAK/NEON_D17_TEAK_DP1_20190615_171836_reflectance_brdf_coeffs_topo_brdf.json'
neon.load_coeffs(brdf_coeffs,'brdf')
