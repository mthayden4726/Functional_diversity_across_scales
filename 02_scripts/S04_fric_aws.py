...
Adapted from S03_fric_iterate to use on an AWS instance. 
...
Output_Dir = '/home/ec2-user/BioSCape_across_scales/01_data/02_processed/'
...
# Step where paralell processing occurs
